...
const BasicTile = ({
  ...
  // console.log("numberof", numberOfReviews);
  ...
  return (
    ...
    >
      <TouchableOpacity style={styles.container} onPress={onPress}>
        ...
        >
          <ImageBackground source={{ uri: image }} style={styles.bg} />
        </View>
        ...
        <View style={styles.info}>
          ...
          <View style={[styles.row, styles.between]}>
            <View style={styles.row}>
              <Text color="tertiary" weight="medium">
                {price}
              </Text>
              <Text color="gray50" style={styles.discount}>
                {beforeDiscount}
              </Text>
            </View>
